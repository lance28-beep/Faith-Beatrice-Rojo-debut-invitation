...
import { AudioProvider } from "@/components/contexts/audio-context"
...
const GuestList = dynamic(
  () =>
    import("@/components/sections/guest-list").then((mod) => ({
      default: mod.GuestList,
    })),
  { ssr: false },
)
          ...
          >
            ...
            {enableDecor && (
              <div className="fixed inset-0 z-0 pointer-events-none">
                <Suspense
                  fallback={
                    <div className="w-full h-full bg-gradient-to-b from-primary/10 to-secondary/5" />
                  }
                >
                  <Silk
                    speed={5}
